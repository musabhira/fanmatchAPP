...
import 'personal_chat_model.dart';
export 'personal_chat_model.dart';

class PersonalChatWidget extends StatefulWidget {
  const PersonalChatWidget({super.key});
...
class _PersonalChatWidgetState extends State<PersonalChatWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PersonalChatModel());
